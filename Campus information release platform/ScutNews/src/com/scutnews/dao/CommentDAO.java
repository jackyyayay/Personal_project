...
public class CommentDAO extends HibernateDaoSupport {
	...
	public List findByPage(int nowPage,int pageSize){
		String hql = "from Comment as u where u.state=1"; 
